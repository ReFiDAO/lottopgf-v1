...
export const METADATA = {
  ...
  longDescription: (
    <p>
      This holiday season, we’re launching The ReFi DAO Holiday Lotto from Dec 18th - 24th!</p>
      <br>
      <p>🌟 Kickstarted with $200 from Glo Dollar and ReFi DAO Global, the prize pool grows further with every ticket sold! 
      If no lucky numbers are drawn on Christmas Day, the winnings split evenly among ticket holders.</p>
      <br>
      <p>🎟 Tickets are $10 USDGLO via Base Network (bridge or swap tokens <a href="https://jumper.exchange/">here</a>). 
